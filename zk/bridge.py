#!/usr/bin/env python3
"""snarkjs → NEAR alt_bn128 wire-format bridge (SHARED).
...
pi_a is negated here: (x, p−y) — the contract expects negA.

Usage:
  python3 bridge.py <dir>          # reads proof.json, vkey.json, public.json
                                   # writes init_args.json, verify_args.json

This is the ONLY bridge. Don't write another one.
"""
import json
import sys
...
def elem(v) -> str:
    """field element → 32B little-endian hex (64 chars)."""
