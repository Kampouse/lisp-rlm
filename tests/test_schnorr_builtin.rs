...
fn test_sha256_hello() {
    ...
    assert_eq!(format!("{}", r),
        "(185 77 39 185 147 77 62 8 165 46 82 215 218 125 171 250 196 132 239 227 122 83 128 238 144 136 247 172 206 239 205 233)");
}
...
#[test]
fn test_schnorr_v1() {
    let pk = "(list 223 241 215 127 42 103 28 95 54 24 135 38 219 35 65 190 88 95 234 29 162 45 222 237 132 64 15 123 80 43 166 89)";
