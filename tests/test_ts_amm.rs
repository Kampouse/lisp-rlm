...
fn amm_constant_product_full_suite() {
    ...
    let call = |m: &str, a: &str, s: &str, v: bool| {
        run(
            st,
            Call {
                acct: A,
    ...
    let a1 = call(
        "addLiquidity",
        r#"{"amtA":"1000","amtB":"1000"}"#,
        "alice.test.near",
        false,
    );
    assert!(
        a1.contains(r#""ra":"1000""#) && a1.contains(r#""ts":"1000""#),
        "alice first LP: {a1}"
    );
    ...
    assert!(
        s1.contains(r#""ra":"1700""#) && s1.contains(r#""rb":"1324""#),
        "swap moved price: {s1}"
    );
    ...
    assert!(
        wa.contains(r#""a":"800""#) && wa.contains(r#""b":"1176""#),
        "alice wallet: {wa}"
    );
    ...
    assert!(
        r1.contains(r#""ra":"1134""#)
            && r1.contains(r#""rb":"883""#)
            && r1.contains(r#""ts":"1000""#),
        "bob exit: {r1}"
    );
    let wb = call(
        "walletOf",
    ...
    assert!(
        wb.contains(r#""a":"566""#) && wb.contains(r#""b":"441""#),
        "bob wallet: {wb}"
    );
    ...
    assert!(
        fin.contains(r#""ra":"1134""#) && fin.contains(r#""rb":"883""#),
        "final pool: {fin}"
    );
