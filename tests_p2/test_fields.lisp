...
(define (run)
  (let* ((args-b64 "eyJhY2NvdW50X2lkIjoiOTQzYWRkYWJkZTc5MTNjNmY1ODA0M2QzNDhlYzc2MzY0MzY4OWI2OGRhMmU3YWIxODZiN2Q3NWUxZDU0NGZmMiJ9")
    ...
    (str-cat "Total: " (to-string (str-len decoded))
      " | supplied: " (to-string (str-len (json-get-str "supplied" decoded)))
      " | collateral: " (to-string (str-len (json-get-str "collateral" decoded)))
      " | borrowed: " (to-string (str-len (json-get-str "borrowed" decoded))))))