;; Check: How long is the inner byte array string?
(define (run)
  (let* ((args-b64 "eyJhY2NvdW50X2lkIjoiOTQzYWRkYWJkZTc5MTNjNmY1ODA0M2QzNDhlYzc2MzY0MzY4OWI2OGRhMmU3YWIxODZiN2Q3NWUxZDU0NGZmMiJ9")
    ...
    (str-cat "RPC result len: " (to-string (str-len rpc-result))
      " | Inner result len: " (to-string (str-len result-obj))
      " | Bytes str len: " (to-string (str-len bytes-str)))))