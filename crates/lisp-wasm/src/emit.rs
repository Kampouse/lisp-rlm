...
pub(crate) const HOST_BASE: u32 = 0xFF00_0000;
pub(crate) const USER_BASE: u32 = 0xFF01_0000;
pub(crate) const TEMP_MEM: i64 = 64;
pub(crate) const INPUT_BUF: i64 = 16384;  // 16KB for input JSON args
pub(crate) const STORAGE_BUF: i64 = 8192;  // 8 bytes for storage read/write buffer
pub(crate) const STORAGE_U128_BUF: i64 = 8208;  // 16 bytes for u128 storage ops
pub(crate) const HEAP_START: i64 = 4096; // heap starts at page 0 offset 4096 (after data segments)
pub(crate) const FN_REF_TAG: i64 = 2;  // (fn_idx << 2) | 2
pub(crate) const CLOSURE_TAG: i64 = 3; // (mem_ptr << 2) | 3
// ~300 Tgas on NEAR ≈ ~10B simple ops. Cap at 1B to be safe (stops runaway, still uses full NEAR runtime).
pub(crate) const GAS_LIMIT: i64 = 1_000_000_000;
pub(crate) const DEPTH_LIMIT: i64 = 512;
pub(crate) const DEPTH_GLOBAL: u32 = 0; // mutable i64 global for call depth

pub(crate) struct FuncDef {
    pub(crate) name: String,
    pub(crate) param_count: usize,
    pub(crate) local_count: usize,
    pub(crate) instrs: Vec<Instruction<'static>>,
}
...
impl WasmEmitter {
    ...
    pub(crate) fn local_idx(&mut self, name: &str) -> u32 {
    ...
    pub(crate) fn need_host(&mut self, idx: usize) { self.host_needed.insert(idx); }
    ...
    pub(crate) fn tc_body(&mut self, body: &LispVal) -> Result<Vec<Instruction<'static>>, String> {
    ...
    pub(crate) fn tc(&mut self, e: &LispVal) -> Result<Vec<Instruction<'static>>, String> {
    ...
    pub(crate) fn tc_let(&mut self, a: &[LispVal]) -> Result<Vec<Instruction<'static>>, String> {
        let mut v = Vec::new();
    ...
    pub(crate) fn tc_if(&mut self, a: &[LispVal]) -> Result<Vec<Instruction<'static>>, String> {
    ...
    pub(crate) fn self_sets(&mut self, e: &LispVal) -> Result<Vec<Instruction<'static>>, String> {
    ...
    pub(crate) fn expr(&mut self, e: &LispVal) -> Result<Vec<Instruction<'static>>, String> {
        match e {
    ...
    pub(crate) fn call(&mut self, op: &str, a: &[LispVal]) -> Result<Vec<Instruction<'static>>, String> {
        match op {
            ...
            "str_cat" => {
                ...
                let _alloc_i = self.local_idx("__stralloc");
                let mut v = Vec::new();
                // Save packed strings
                ...
                let _total_len = 0; // computed at runtime
...
fn parse_and_compile(source: &str, near: bool) -> Result<WasmEmitter, String> {
    let exprs = lisp_core::parser::parse_all(source)?;
...
mod tests {
    ...
    #[test]
    pub(crate) fn test_near_counter() {
        let src = r#"
(memory 1)
...
"#;
    ...
    #[test]
    pub(crate) fn test_tc_nested_if() {
    ...
    #[test]
    pub(crate) fn test_implicit_begin_let() {
    ...
    #[test]
    pub(crate) fn test_implicit_begin_define() {
...
mod ycomb_test {
    use super::*;
    #[test]
    pub(crate) fn test_self_call_non_tc() {
...
mod ycomb_run_test {
    use super::*;
    #[test]
    pub(crate) fn test_ycomb_factorial() {
...
mod lambda_test {
    use super::*;
    #[test]
    pub(crate) fn test_simple_lambda() {
