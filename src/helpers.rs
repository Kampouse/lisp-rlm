...
pub const BUILTIN_NAMES: &[&str] = &[
    ...
    "llm", "llm-code",
    "contract-check-param", "contract-check-return", "contract-wrap",
    "check", "check!", "matches?", "valid-type?", "type-of",
    "defschema", "validate", "schema", "infer-type",
    ...
    "fork", "fork-exec", "mark-pure", "memoize", "par-map", "par-filter", "snapshot", "rollback",
    "fmt", "inspect", "to-json", "str-replace",
    "force", "make-promise", "promise?", "macro?",
    "delay", "try-catch-impl", "define-values", "let-values", "let*-values",
    "macroexpand",
    "case-lambda", "make-case-lambda",
    "assv", "assq", "memv", "memq",
