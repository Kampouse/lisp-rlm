...
impl WasmEmitter {
    ...
    pub(crate) fn ensure_val_eq_helper(&mut self) -> u32 {
        ...
        v.push(I::I64ShrU);
        v.push(I::LocalSet(4)); // la
        v.push(I::LocalGet(1));
        v.push(I::I64Const(TAG_BITS));
        v.push(I::I64ShrU);
        v.push(I::I64Const(32));
        v.push(I::I64ShrU);
        v.push(I::LocalSet(5)); // lb
        v.push(I::LocalGet(4));
        v.push(I::LocalGet(5));
        v.push(I::I64Ne);
        v.push(I::If(wasm_encoder::BlockType::Empty));
        ...
        v.push(I::LocalSet(8)); // na
        v.push(I::LocalGet(1));
        v.push(I::I64Const(TAG_BITS));
        v.push(I::I64ShrU);
        v.push(I::I32WrapI64);
        v.push(I::I64Load(ma8.clone()));
        v.push(I::LocalSet(9)); // nb
        v.push(I::LocalGet(8));
        v.push(I::LocalGet(9));
        v.push(I::I64Ne);
        v.push(I::If(wasm_encoder::BlockType::Empty));
