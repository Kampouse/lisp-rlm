    ...
    pub(crate) fn call_fp(
        ...
        match op {
            ...
            "fp64/add" => {
                ...
                v.push(Instruction::LocalSet(sl));
                v.extend(sa);
                v.push(Instruction::I32WrapI64);
                v.push(Instruction::I64Load(wasm_encoder::MemArg {
                    offset: 8,
                ...
                v.push(Instruction::LocalSet(sh));
                // Load dst low
                v.extend(da.clone());
                v.push(Instruction::I32WrapI64);
                v.push(Instruction::I64Load(wasm_encoder::MemArg {
                ...
                v.push(Instruction::LocalGet(sl));
                ...
                v.push(Instruction::LocalGet(sh));
            ...
            "fp64/mul" => {
                ...
                let emit_mul128 =
                    |v: &mut Vec<Instruction<'static>>, x: u32, y: u32, hi: u32, lo: u32| {
                        // x_lo = x & 0xFFFFFFFF
                        v.push(Instruction::LocalGet(x));
                        ...
                        // y_lo = y & 0xFFFFFFFF
                        v.push(Instruction::LocalGet(y));
                        v.push(Instruction::I64Const(0xFFFFFFFF));
                        v.push(Instruction::I64And);
                        v.push(Instruction::LocalSet(y_lo));
                        // y_hi = y >> 32
                        v.push(Instruction::LocalGet(y));
                        v.push(Instruction::I64Const(32));
                        v.push(Instruction::I64ShrU);
                        v.push(Instruction::LocalSet(y_hi));
                        // ll = x_lo * y_lo
                        v.push(Instruction::LocalGet(x_lo));
                        v.push(Instruction::LocalGet(y_lo));
                        v.push(Instruction::I64Mul);
                        v.push(Instruction::LocalSet(ll));
                        // lh = x_lo * y_hi
                        v.push(Instruction::LocalGet(x_lo));
                        v.push(Instruction::LocalGet(y_hi));
                        v.push(Instruction::I64Mul);
                        v.push(Instruction::LocalSet(lh));
                        // hl = x_hi * y_lo
                        v.push(Instruction::LocalGet(x_hi));
                        v.push(Instruction::LocalGet(y_lo));
                        v.push(Instruction::I64Mul);
                        v.push(Instruction::LocalSet(hl));
                        // hh = x_hi * y_hi
                        v.push(Instruction::LocalGet(x_hi));
                        v.push(Instruction::LocalGet(y_hi));
                        v.push(Instruction::I64Mul);
                        v.push(Instruction::LocalSet(hh));
                        // mid = lh + hl, mid_carry = mid < lh
                        v.push(Instruction::LocalGet(lh));
                        v.push(Instruction::LocalGet(hl));
                        v.push(Instruction::I64Add);
                        v.push(Instruction::LocalTee(mid));
                        v.push(Instruction::LocalGet(lh));
                        v.push(Instruction::I64LtU);
                        v.push(Instruction::I64ExtendI32U);
                        v.push(Instruction::LocalSet(mc));
                        ...
                        v.push(Instruction::I64Shl);
                        v.push(Instruction::I64Add);
                        v.push(Instruction::LocalTee(lo));
                        v.push(Instruction::LocalGet(ll));
                        v.push(Instruction::I64LtU);
                        v.push(Instruction::I64ExtendI32U);
                        v.push(Instruction::LocalSet(lc));
                        ...
                        v.push(Instruction::I64ShrU);
                        v.push(Instruction::I64Add);
                        v.push(Instruction::LocalGet(mc));
                        v.push(Instruction::I64Const(32));
                        v.push(Instruction::I64Shl);
                        v.push(Instruction::I64Add);
                        v.push(Instruction::LocalGet(lc));
                        v.push(Instruction::I64Add);
                ...
                v.push(Instruction::LocalGet(cross1_lo));
                v.push(Instruction::LocalGet(cross2_lo));
                v.push(Instruction::I64Add);
                v.push(Instruction::LocalTee(tmp));
                v.push(Instruction::LocalGet(cross1_lo));
                v.push(Instruction::I64LtU);
                v.push(Instruction::I64ExtendI32U);
                v.push(Instruction::LocalSet(tmp2)); // tmp2 = carry_a
                                                     // tmp = cross_lo
                                                     // cross_hi = cross1_hi + cross2_hi + carry_a
                v.push(Instruction::LocalGet(cross1_hi));
                v.push(Instruction::LocalGet(cross2_hi));
                v.push(Instruction::I64Add);
                v.push(Instruction::LocalGet(tmp2));
                v.push(Instruction::I64Add);
                ...
                v.push(Instruction::LocalGet(albl_hi));
                v.push(Instruction::I64Add);
                v.push(Instruction::LocalTee(rl));
                v.push(Instruction::LocalGet(tmp));
                v.push(Instruction::I64LtU);
                v.push(Instruction::I64ExtendI32U);
                v.push(Instruction::LocalSet(tmp)); // tmp = carry_b
            ...
            "fp64/lt" => {
                ...
                v.push(Instruction::LocalSet(h1));
                v.extend(a2.clone());
                v.push(Instruction::I32WrapI64);
                v.push(Instruction::I64Load(wasm_encoder::MemArg {
                    offset: 8,
                ...
                v.push(Instruction::LocalSet(h2));
                // if h1 < h2: return 1
                v.push(Instruction::LocalGet(h1));
                v.push(Instruction::LocalGet(h2));
                v.push(Instruction::I64LtU);
            ...
            "fp64/div" => {
                ...
                let emit_mul128 = |v: &mut Vec<Instruction<'static>>,
                                   x: u32,
                                   y: u32,
                                   hi_dst: u32,
                                   lo_dst: u32| {
                    ...
                    v.push(Instruction::I64Const(0xFFFFFFFF));
                    v.push(Instruction::I64And);
                    v.push(Instruction::LocalSet(m_xlo));
                    v.push(Instruction::LocalGet(x));
                    v.push(Instruction::I64Const(32));
                    v.push(Instruction::I64ShrU);
                    v.push(Instruction::LocalSet(m_xhi));
                    v.push(Instruction::LocalGet(y));
                    v.push(Instruction::I64Const(0xFFFFFFFF));
                    v.push(Instruction::I64And);
                    v.push(Instruction::LocalSet(m_ylo));
                    v.push(Instruction::LocalGet(y));
                    v.push(Instruction::I64Const(32));
                    v.push(Instruction::I64ShrU);
                    v.push(Instruction::LocalSet(m_yhi));
                    v.push(Instruction::LocalGet(m_xlo));
                    v.push(Instruction::LocalGet(m_ylo));
                    v.push(Instruction::I64Mul);
                    v.push(Instruction::LocalSet(m_ll));
                    v.push(Instruction::LocalGet(m_xlo));
                    v.push(Instruction::LocalGet(m_yhi));
                    v.push(Instruction::I64Mul);
                    v.push(Instruction::LocalSet(m_lh));
                    v.push(Instruction::LocalGet(m_xhi));
                    v.push(Instruction::LocalGet(m_ylo));
                    v.push(Instruction::I64Mul);
                    v.push(Instruction::LocalSet(m_hl));
                    v.push(Instruction::LocalGet(m_xhi));
                    v.push(Instruction::LocalGet(m_yhi));
                    v.push(Instruction::I64Mul);
                    v.push(Instruction::LocalSet(m_hh));
                    v.push(Instruction::LocalGet(m_lh));
                    v.push(Instruction::LocalGet(m_hl));
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalTee(m_mid));
                    v.push(Instruction::LocalGet(m_lh));
                    v.push(Instruction::I64LtU);
                    v.push(Instruction::I64ExtendI32U);
                    v.push(Instruction::LocalSet(m_mc));
                    v.push(Instruction::LocalGet(m_ll));
                    v.push(Instruction::LocalGet(m_mid));
                    v.push(Instruction::I64Const(32));
                    v.push(Instruction::I64Shl);
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalTee(m_lo));
                    v.push(Instruction::LocalGet(m_ll));
                    v.push(Instruction::I64LtU);
                    v.push(Instruction::I64ExtendI32U);
                    v.push(Instruction::LocalSet(m_lc));
                    v.push(Instruction::LocalGet(m_hh));
                    v.push(Instruction::LocalGet(m_mid));
                    v.push(Instruction::I64Const(32));
                    v.push(Instruction::I64ShrU);
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalGet(m_mc));
                    v.push(Instruction::I64Const(32));
                    v.push(Instruction::I64Shl);
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalGet(m_lc));
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalSet(hi_dst));
                    v.push(Instruction::LocalGet(m_lo));
                    v.push(Instruction::LocalSet(lo_dst));
                };

                // emit_fp64_mul: full Q64.64 multiply of {a_lo,a_hi} * {b_lo,b_hi} → {dst_lo,dst_hi}
                let emit_fp64_mul = |v: &mut Vec<Instruction<'static>>,
                                     a_lo: u32,
                                     a_hi: u32,
                                     b_lo: u32,
                                     b_hi: u32,
                    ...
                    v.push(Instruction::LocalGet(c1_lo));
                    v.push(Instruction::LocalGet(c2_lo));
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalTee(tmp));
                    v.push(Instruction::LocalGet(c1_lo));
                    v.push(Instruction::I64LtU);
                    v.push(Instruction::I64ExtendI32U);
                    v.push(Instruction::LocalSet(tmp2));
                    v.push(Instruction::LocalGet(c1_hi));
                    v.push(Instruction::LocalGet(c2_hi));
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalGet(tmp2));
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalSet(m_mid));
                    // result_lo = cross_lo + ab_hi
                    v.push(Instruction::LocalGet(tmp));
                    v.push(Instruction::LocalGet(ab_hi));
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalTee(dst_lo));
                    v.push(Instruction::LocalGet(tmp));
                    v.push(Instruction::I64LtU);
                    v.push(Instruction::I64ExtendI32U);
                    v.push(Instruction::LocalSet(tmp));
                    // result_hi = a_hi*b_hi + cross_hi + carry
                    v.push(Instruction::LocalGet(a_hi));
                    v.push(Instruction::LocalGet(b_hi));
                    v.push(Instruction::I64Mul);
                    v.push(Instruction::LocalGet(m_mid));
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalGet(tmp));
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalSet(dst_hi));
                };
                ...
                v.push(Instruction::LocalGet(bh));
                v.push(Instruction::I64Eqz);
                ...
                v.push(Instruction::LocalSet(x_lo));
                v.push(Instruction::I64Const(-1));
                v.push(Instruction::LocalGet(bl));
                v.push(Instruction::I64DivU);
                v.push(Instruction::LocalSet(x_hi));
                v.push(Instruction::Else);
                // bh >= 1
                ...
                for _ in 0..3 {
                    ...
                    v.push(Instruction::I64Const(0));
                    v.push(Instruction::LocalGet(tx_lo));
                    v.push(Instruction::I64Sub);
                    v.push(Instruction::LocalTee(cl));
                    v.push(Instruction::I64Const(0));
                    v.push(Instruction::I64GtU); // borrow if cl wrapped (cl > 0 when it should be 0-tx_lo)
                    v.push(Instruction::I64ExtendI32U);
                    v.push(Instruction::LocalSet(tmp));
                    // ch = 2 - tx_hi - borrow
                    v.push(Instruction::I64Const(2));
                    v.push(Instruction::LocalGet(tx_hi));
                    v.push(Instruction::I64Sub);
                    v.push(Instruction::LocalGet(tmp));
                    v.push(Instruction::I64Sub);
            ...
            "fp64/sqrt" => {
                ...
                v.push(Instruction::LocalGet(r64));
                v.push(Instruction::LocalSet(p64));
                ...
                for _ in 0..6 {
                    ...
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalTee(sum_l));
                    v.push(Instruction::LocalGet(rl));
                    v.push(Instruction::I64LtU);
                    v.push(Instruction::I64ExtendI32U);
                    v.push(Instruction::LocalSet(tmp));
                    ...
                    v.push(Instruction::LocalGet(tmp));
                    v.push(Instruction::I64Add);
                    v.push(Instruction::LocalSet(sum_h));

                    // r = sum >> 1 (Q64.64 right shift by 1)
                    // new_rl = (sum_l >> 1) | (sum_h << 63)
                    // new_rh = sum_h >> 1
                    v.push(Instruction::LocalGet(sum_l));
                    v.push(Instruction::I64Const(1));
                    v.push(Instruction::I64ShrU);
                    v.push(Instruction::LocalGet(sum_h));
            ...
            "fp/sqrt" => {
                ...
                let inner = &LispVal::List(vec![LispVal::Sym("sqrt".into()), a[0].clone()]);
