...
impl WasmEmitter {
    pub(crate) fn call_dict(
        ...
        match op {
            "dict" => {
                if a.len() % 2 != 0 {
                    return Err("dict: expected even number of args (key val pairs)".into());
                }
                let n_pairs = a.len() / 2;
            ...
            "dict/get" => {
                if a.len() != 2 {
                    return Err("dict/get: expected 2 args (dict key)".into());
                }
                ...
                v.push(Instruction::I32WrapI64);
                v.push(Instruction::I64Load(ma));
                v.push(Instruction::LocalSet(k_raw));
                // Compare with search key
                v.push(Instruction::LocalGet(key));
                v.push(Instruction::LocalGet(k_raw));
            ...
            "dict/set" => {
                if a.len() != 3 {
                    return Err("dict/set: expected 3 args (dict key val)".into());
                }
                ...
                v.push(Instruction::LocalSet(idx));
                v.push(Instruction::I64Const(0));
                v.push(Instruction::LocalSet(found)); // 0=not found
                ...
                // Copy all pairs
                v.push(Instruction::I64Const(0));
                v.push(Instruction::LocalSet(i2));
                v.push(Instruction::Block(BlockType::Empty));
                v.push(Instruction::Loop(BlockType::Empty));
                v.push(Instruction::LocalGet(i2));
                v.push(Instruction::LocalGet(n));
                v.push(Instruction::I64GeU);
                v.push(Instruction::BrIf(1));
                ...
                v.push(Instruction::I32WrapI64);
                v.push(Instruction::I64Load(ma));
                v.push(Instruction::LocalSet(v_tmp));
                v.push(Instruction::LocalGet(new_ptr));
                v.push(Instruction::I64Const(8));
                v.push(Instruction::LocalGet(i2));
                v.push(Instruction::I64Const(16));
            ...
            "dict/has?" => {
                if a.len() != 2 {
                    return Err("dict/has?: expected 2 args (dict key)".into());
                }
            ...
            "dict/keys" => {
                if a.len() != 1 {
                    return Err("dict/keys: expected 1 arg (dict)".into());
                }
            ...
            "dict/vals" => {
                if a.len() != 1 {
                    return Err("dict/vals: expected 1 arg (dict)".into());
                }
