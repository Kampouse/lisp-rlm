...
# FULL 34-step differential: event-auth included (TS port 2026-09-02)
...
for line in sys.stdin:
    ...
    print(json.dumps(d))' > /tmp/diff-steps-full.jsonl

N=$($PY -c 'print(sum(1 for _ in open("/tmp/diff-steps-full.jsonl")))')
